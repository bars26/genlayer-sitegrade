...
import { useSitesByOwner } from "@/lib/hooks/useSiteGrade";
...
export function AccountPanel() {
  ...
  const { data: ownedSiteIds } = useSitesByOwner(address);
  const ownedSitesCount = ownedSiteIds?.length ?? 0;
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        ...
        <DialogContent className="brand-card border-2">
          <DialogHeader>
            ...
            <DialogDescription>
              Connect your MetaMask wallet to register or re-audit sites
            </DialogDescription>
          </DialogHeader>
    ...
    <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
      <div className="flex items-center gap-4">
        <div className="brand-card px-4 py-2 flex items-center gap-3">
          ...
          <div className="flex items-center gap-1">
            <span className="text-sm font-semibold text-accent">{ownedSitesCount}</span>
            <span className="text-xs text-muted-foreground">sites graded</span>
          </div>
        </div>
      ...
      <DialogContent className="brand-card border-2">
        ...
        <div className="space-y-4 mt-4">
          ...
          <div className="brand-card p-4 space-y-2">
            <p className="text-sm text-muted-foreground">Your Sites</p>
            <div className="text-center">
              <p className="text-xl font-bold text-accent">{ownedSitesCount}</p>
              <p className="text-xs text-muted-foreground">registered by this wallet</p>
            </div>
          </div>
