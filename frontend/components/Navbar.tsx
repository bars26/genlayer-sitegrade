...
export function Navbar() {
  ...
  const gradedCount = sites.length;
  const alertCount = sites.filter((s) => s.grade === "D" || s.grade === "F").length;
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg md:text-xl font-bold ml-2">SiteGrade</span>
              </div>
              ...
              <div className="hidden md:flex items-center gap-6 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-foreground font-bold text-accent">{gradedCount}</span>
                </div>
                {alertCount > 0 && (
                  <div className="flex items-center gap-2">
                    <span className="text-muted-foreground">Below C:</span>
