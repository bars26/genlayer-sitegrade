...
```bash
# Linting
genvm-lint check contracts/site_grade.py    # Lint a contract
...
- Contract interactions: `frontend/lib/contracts/SiteGrade.ts`
- React hooks: `frontend/lib/hooks/useSiteGrade.ts`
